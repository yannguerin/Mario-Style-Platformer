...
class Overworld:
    def __init__(self, start_level, max_level, surface, create_level, coins, create_shop, owned_items):
        #setup
    ...
    def input(self):
        ...
        if not self.moving and self.allow_input:
            if (keys[pygame.K_RIGHT] or keys[pygame.K_d]) and self.current_level < self.max_level:
                ...
                self.create_level(self.current_level, self.owned_items)
            elif keys[pygame.K_e]:
                self.create_shop(self.coins, self.display_surface, self.owned_items, self.max_level)
